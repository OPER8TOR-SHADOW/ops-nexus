...
def build_window():
    ...
    title = ctk.CTkLabel(main, text="Dashboard", font=("Segoe UI", 34, "bold"))
    title.pack(anchor="w", padx=20, pady=(20, 10))

    subtitle = ctk.CTkLabel(main, text="Welcome back to OPS Nexus", font=("Segoe UI", 18))
    ...
    for name, status in [
        ...
        ctk.CTkLabel(card, text=name, font=("Segoe UI", 18, "bold")).pack(
            pady=(18, 8)
        )
        ctk.CTkLabel(card, text=status, font=("Segoe UI", 14)).pack()
    ...
    log = ctk.CTkTextbox(main, height=260)
    log.pack(fill="both", expand=True, padx=20, pady=(10, 20))
